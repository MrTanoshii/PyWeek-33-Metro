...
import mapview
import random
from constants import SCREEN_WIDTH, SCREEN_HEIGHT, SPRITE_PLAYER_INIT_ANGLE, DEATH, MOVE_DIRECTION, LEVEL1
...
# DUMMY Game View Map2 India Can be implemented in Single Game View itself using Scene
