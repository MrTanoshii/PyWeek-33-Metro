...
MAP_MONUMENTS_LIST = [
    {
        ...
        "enemy": [ENEMY_LIST["tank"], ENEMY_LIST["soldier desert"]],
        "player": "donky",
    ...
    },
    {
        ...
        "enemy": [ENEMY_LIST["tank"], ENEMY_LIST["soldier forest"], ENEMY_LIST["bear ak"]],
        "player": "donky",
        "sfx_click": AUDIO.SOUND["ui_click"]["name"],
        "sfx_gain": AUDIO.SOUND["ui_click"]["gain"],
        "bgm_name": AUDIO.SOUND["bgm_3"]["name"],
    ...
    },
    {
        ...
        "enemy": [ENEMY_LIST["tank"], ENEMY_LIST["soldier polar"]],
        "player": "donky",
        "sfx_click": AUDIO.SOUND["ui_click"]["name"],
        "sfx_gain": AUDIO.SOUND["ui_click"]["gain"],
        "bgm_name": AUDIO.SOUND["bgm_3"]["name"],
    ...
    },
    {
        ...
        "center_y": 180,
        "assets": ["cactus256.png", "tree.png"],
        "enemy": [ENEMY_LIST["tank"], ENEMY_LIST["soldier forest"]],
        "player": "donky",
        "sfx_click": AUDIO.SOUND["ui_click"]["name"],
        "sfx_gain": AUDIO.SOUND["ui_click"]["gain"],
        "bgm_name": AUDIO.SOUND["bgm_3"]["name"],
