        ...
        for weapon in C.WEAPON_LIST:
            if weapon_name in weapon["name"]:
                ...
                self.texture = arcade.load_texture(
                    "src/resources/images/weapon/" + self.img_name + "/" + self.img_name + ".png",
                    weapon["center_x"],
                    weapon["center_y"],
                    weapon["width"],
                    weapon["height"])
                ...
                for _i, sfx in enumerate(Audio.sfx_player_weapon_shoot_list):
                    if sfx["weapon_name"] == self.weapon_name:
