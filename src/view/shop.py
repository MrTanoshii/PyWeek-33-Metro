...
class ShopView(arcade.View):
    def __init__(self, mapview):
        ...
        self.gold_sprite = arcade.Sprite(
            "src/resources/images/map/gold-bar.png", 0.6 * lib.global_scale())
        ...
        for weapon in C.WEAPON_LIST:
            path = f"src/resources/images/weapon/{weapon['img_name']}/{weapon['img_name']}.png"
        ...
        self.button = arcade.Sprite(
            filename="src/resources/images/pause_view/btn_back_to_map.png",
